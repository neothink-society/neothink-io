...
const stageCards = [
  {
    icon: Rocket,
    name: "Ventures",
    tagline: "Early-Stage Value Creation",
    description: "New ideas becoming reality. Startups and projects launched by Fellowship members, backed by the Neothink ecosystem.",
    href: "/ventures",
  },
  {
    icon: Building2,
    name: "Enterprises",
    tagline: "Scaled Value Creation",
    description: "Proven ventures with sustainable revenue. Established businesses providing employment and resources for the Movement.",
    href: "/enterprises",
  },
  {
    icon: Factory,
    name: "Industries",
    tagline: "Systemic Value Creation",
    description: "Entire sectors shaped by Neothink enterprises. Complete ecosystems of value creation that transform markets.",
    href: "/industries",
  },
]
          ...
          <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl py-16 text-center sm:py-20 lg:py-24">
              ...
              <p className="mx-auto max-w-2xl text-lg text-white/70 sm:text-xl">
                The economic ecosystem where value creation becomes reality
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <p className="text-lg leading-relaxed text-white/70 sm:text-xl">
                Command is the economic engine that{" "}
                <span className="text-white">funds our Movement</span> and{" "}
                <span className="text-white">rewards our Fellowship</span>—where
                integrated thinkers create{" "}
                <span className="text-white">ventures</span>,{" "}
                <span className="text-white">enterprises</span>, and{" "}
                <span className="text-white">industries</span> that transform markets.
              </p>
            </div>
          </div>
        </section>
